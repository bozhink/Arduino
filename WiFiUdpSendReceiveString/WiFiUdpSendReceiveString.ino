...
void loop() {
  ...
  if (packetSize) {
    if (Serial) Serial.print("Received packet of size ");
    if (Serial) Serial.println(packetSize);
    if (Serial) Serial.print("From ");
    IPAddress remoteIp = Udp.remoteIP();
    if (Serial) Serial.print(remoteIp);
    if (Serial) Serial.print(", port ");
    if (Serial) Serial.println(Udp.remotePort());
    ...
    if (Serial) Serial.println("Contents:");
    if (Serial) Serial.println(packetBuffer);
